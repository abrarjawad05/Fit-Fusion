    ...
    <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-lg">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full px-6 py-2 font-medium bg-teal-500 text-white transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]"
          >
            Calculate BMI
          </button>
        </form>
